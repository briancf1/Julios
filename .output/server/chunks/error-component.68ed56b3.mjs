...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.82cc7fc1.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.502ea59f.mjs'));
...
//# sourceMappingURL=error-component.68ed56b3.mjs.map
