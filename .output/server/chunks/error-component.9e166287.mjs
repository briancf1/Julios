...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.8af2d232.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.f7fc9ac5.mjs'));
...
//# sourceMappingURL=error-component.9e166287.mjs.map
